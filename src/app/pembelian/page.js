...
export default function Page() {
    ...
    console.log(confirmBelanja)
    return (
    <div className="space-y-5 max-w-7xl mx-auto">
        <div className='flex shadow-md rounded-lg p-3 gap-5'>
            <div className="max-w-2xl space-y-3 px-2 rounded-lg">
                ...
                <div className="space-y-3 flex flex-col justify-between h-[30rem] py-3">
            ...
            <div className="flex-1 w-full flex flex-col space-y-3">
                ...
                <div className="w-full shadow-sm h-96 overflow-scroll">
        ...
        <div className="w-full shadow-md p-3 flex">
            <div className="w-full flex flex-col space-y-2">
                <div className="w-full flex">
                    ...
                    <div className="flex-1 py-1 px-2 group-hover:bg-violet-200 group-hover:duration-150 text-left border border-biolet-100 text-xl font-semibold" colSpan={3}>{formatter.format(keranjangBelanja.reduce((gtotal, obj) => gtotal + obj.total, 0))}</div>
                </div>
                <div className="w-full flex">
                ...
                <div className="w-full flex">
                    ...
                    <div className="flex-1 py-1 px-2 group-hover:bg-violet-200 group-hover:duration-150 text-left border border-biolet-100 text-xl font-semibold" colSpan={3}>{dibayarkan === null ? 0 : formatter.format(dibayarkan - keranjangBelanja.reduce((gtotal, obj) => gtotal + obj.total, 0))}</div>
                </div>
            </div>
            <div className="flex flex-col items-center justify-center p-3 space-y-3 font-semibold">
                <button className="w-full px-5 py-3 rounded-lg bg-green-300 hover:bg-green-400 active:bg-green-500" onClick={handleClickSimpanSeluruhPembelian}>Selesai</button>
                <button className="w-full px-5 py-3 rounded-lg bg-red-300 hover:bg-red-400 active:bg-red-500" onClick={handleClickBatalPembelian}>Batal</button>
            </div>
        </div>
    </div>
    )
